...
Before approving copy, check that:

- it preserves the page job, fixed facts, approved claims and service ownership;
- a reader can connect their situation to the actual MindWP responsibility;
- proof is real and labelled only where needed;
- clinical, legal, privacy, consent and automation boundaries remain intact;
- tools do not become the product;
- industry detail is genuine rather than substituted;
- headings, paragraphs, artefacts and FAQs do not repeat the same explanation;
- CTA language matches the action selected by Strategy or the page plan;
- no provisional filler or unsupported operational detail remains.
