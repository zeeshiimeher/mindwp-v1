...
| 6 | SMART WEBSITE | Build around the questions, evidence and actions that matter to the decision. |
| 7 | LOCAL VISIBILITY | Be found for the real services and locations your business can support. |
...
| 11 | SELECTED WORK | See how the thinking holds together in finished websites. |
| 12 | CLEAR OWNERSHIP | Know what MindWP builds, what your business owns and what happens after launch. |
| 13 | RIGHT FIT | For independent clinics and specialist service businesses where the decision deserves care. |
| 14 | VISIBILITY & ENQUIRY REVIEW | First we review what is helping, what is getting in the way and what matters next. |
| 15 | STRAIGHT ANSWERS | Questions about smart websites, connected support and working with MindWP. |
| 16 | VISIBILITY & ENQUIRIES | See what your website and enquiry path should make easier next. |
