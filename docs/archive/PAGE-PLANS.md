...
- **Primary target:** `website design for service businesses` — _open: search volume for this and for clinic-specific variants has not been researched. Do not treat it as validated._
